...
public class WordCount {
    ...
    public static void main(String[] args) {
        ...
        builder.<String, String>stream(Arrays.asList("streams-plaintext-input", "streams-plaintext-input-2"))
                .flatMapValues(value -> Arrays.asList(value.toLowerCase(Locale.getDefault()).split("\\W+")))
                .groupBy((key, value) -> {System.out.println(key+"="+value); return value;})
